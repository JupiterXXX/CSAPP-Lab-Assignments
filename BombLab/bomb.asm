...
# store 6 numbers at %rsp, %rsp + 4， %rsp + 8, %rsp + 12, %rsp + 16, %rsp + 20
# they have to satisfy following rules: a1 <= 6; a1 != a2; a1 != a3; a1 != a4; a1 != a5; a1 != a6, or bomb.
...
# compute 7 -ai for each ai 
  ...
  401203:	c3                   	retq   
# input: a1,a2,a3,a4,a5,a6. After reordering, the (ai)th node will be put on the (i)th position.
# for example:
# a1 a2 a3 a4 a5 a6           
# 4  3  2  1  6  5   ==>  1 2 3 4 5 6
# The result should be decreasing. Considering the 7-ai operation. The input should be 4 3 2 1 6 5.
